...
/**
 * Keeps Pig God's good-role coin economy in SparkWitch after NoellesRoles buffs move out.
 * NoellesRoles 增强迁出后，保留皮革噶的自己的好人金币逻辑。
 */
public final class PigGodEconomyService {
    public static final int INITIAL_MONEY = 0;
    public static final int TASK_MONEY_REWARD = 50;
    private static boolean registered;

    private PigGodEconomyService() {
    }
    ...
    public static synchronized void register() {
        ...
        registered = true;
        CanSeeMoney.EVENT.register(PigGodEconomyService::canSeeMoney);
    }
    ...
    static boolean shouldInitializeMoney(@Nullable Role role) {
        return PigGodRules.isPigGod(role);
    }
    ...
    static CanSeeMoney.Result moneyVisibilityResult(@Nullable Role role) {
        return PigGodRules.isPigGod(role) ? CanSeeMoney.Result.ALLOW : null;
    }
